...
export const translations = {
    en: {
        ...
        practice: {
            ...
            verifying: "AI is checking your answer...",
            verifyingMessage: "Determining if your answer is equivalent to the correct one.",
        ...
        settings: {
            ...
            systemResetPasswordPrompt: "Enter your admin password to confirm system reset:",
            systemResetPasswordRequired: "Password is required",
    ...
    zh: {
        ...
        practice: {
            ...
            verifying: "正在 AI 智能判分...",
            verifyingMessage: "正在判断你的答案是否与标准答案等价，请稍候",
            yourNotes: "你的笔记：",
            checkAnswer: "查看答案",
            hideAnswer: "隐藏答案",
            correctAnswer: "参考答案",
        ...
        settings: {
            ...
            systemResetPasswordPrompt: "请输入管理员密码以确认系统重置：",
            systemResetPasswordRequired: "必须输入密码",
